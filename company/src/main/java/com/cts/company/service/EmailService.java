...
public class EmailService {
	...
	private static final String username="jagan5043@gmail.com";
	private static final String password = "amrinravi";
	...
	public boolean sendEmail(String emailid, String twoFaCode) throws AddressException, MessagingException {
		...
		message.addRecipient(Message.RecipientType.TO, new InternetAddress(emailid));
		 ...
		 message.setSubject("Two Factor Authentication code from Stock App");
